    ...
    <>
      <Container className={styles["container-content"]}>
        <Row className="d-flex flex-column p-1">
          ...
          <Col sm={8}>
            <p>
              Quizás eres un programador noble que está comenzando a desenvolverse en algún lenguaje
          ...
          <Col sm={8} className=" d-flex justify-content-center">
            <img alt="foto content" className={styles["studying-img"]} src={studying} />
          </Col>
          <Col sm={8}>
